...
public class RetryScreen extends SuperMontyScreen {
     ...
     * @param game
     */
    public RetryScreen(Game game) {
        super(game);
    }

    @Override
    public void show () {
        introControl = new TextureRegion(new Texture(Gdx.files.internal("data/retry.png")), 0, 0, 480, 320);
