...
public class Level2IntroScreen extends SuperMontyScreen {
    private final Animation<TextureRegion> animation = GifDecoder.loadGIFAnimation(Animation.PlayMode.LOOP, Gdx.files.internal("data/level_intros/intro_level_2.gif").read());
     ...
     * @param game
     */
    public Level2IntroScreen(Game game) {
        super(game);
    }
