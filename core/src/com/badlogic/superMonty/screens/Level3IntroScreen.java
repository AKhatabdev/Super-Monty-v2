...
public class Level3IntroScreen extends SuperMontyScreen {
    private final Animation<TextureRegion> animation = GifDecoder.loadGIFAnimation(Animation.PlayMode.LOOP, Gdx.files.internal("data/level_intros/intro_level_3.gif").read());
    SpriteBatch batch;
    float time = 0;
    float elapsed;
     ...
     * @param game
     */
    public Level3IntroScreen(Game game) {
        super(game);
    }
